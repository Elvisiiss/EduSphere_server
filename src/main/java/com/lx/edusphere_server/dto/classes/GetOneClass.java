...
public class GetOneClass {
    ...
    private Set<Integer> students_id;
    private Set<subject_teacher> subject_teacher;

    public Set<Integer> getStudents_id() {
        return students_id;
    }

    public void setStudents_id(Set<Integer> students_id) {
    ...
    public Set<subject_teacher> getSubject_teacher() {
        return subject_teacher;
    }

    public void setSubject_teacher(Set<subject_teacher> subject_teacher) {
